...
# ============================================================
# ЯНДЕКС МУЗЫКА
# ПОЛУЧЕНИЕ ТОЧНЫХ МЕТАДАННЫХ ПО ID
# ============================================================
...
def get_yandex_music_info(url):
    ...
    # --------------------------------------------------------
    # API может вернуть объект result
    # --------------------------------------------------------
    ...
    if isinstance(result, dict):
        ...
        # Иногда track находится внутри result
        ...
        if isinstance(track, dict):
            ...
            # Если result сам является track
            result = result
...
def find_and_download_track(
    ...
    #
    # ВАЖНО:
    # Для Яндекс Музыки он НЕ используется.
    # --------------------------------------------------------
