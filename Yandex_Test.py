...
def find_and_download_track(
    ...
    # 4. РЕЗЕРВНЫЙ YT-DLP
    #
    # ЖЁСТКО ОГРАНИЧЕН YOUTUBE.
    #
    # Для Яндекс Музыки youtube_url == None.
    # --------------------------------------------------------
    ...
    # ЯНДЕКС:
    #
    # После трёх внешних источников выполнение заканчивается.
    # --------------------------------------------------------
...
def process_single_track(
    ...
    # ВАЖНО:
    #
    # Яндекс URL НЕ передаётся как youtube_url.
    #
    # Для Яндекса:
    #     youtube_url = None
    #
    # Для YouTube:
    #     youtube_url = исходная YouTube-ссылка
    # --------------------------------------------------------
