...
# ------------------------------------------------------------
# ПОЛУЧЕНИЕ ТОЧНЫХ ДАННЫХ ЯНДЕКС ПО ID
# ------------------------------------------------------------
...
def find_and_download_track(
    ...
    #
    # ВАЖНО:
    # Для Яндекс Музыки прямой yt-dlp НЕ используем.
    # Для YouTube Music оставляем старую рабочую логику.
    # --------------------------------------------------------
