...
def get_yandex_music_info(url):
    ...
    try:
        ...
        print()
        print(
            "Ошибка соединения с API Яндекс Музыки:"
        )
    ...
    try:
        ...
        print()
        print(
            "Ошибка обработки JSON Яндекс API:"
        )
    ...
    if isinstance(result, dict):
        ...
        if not isinstance(track, dict):
            ...
            print()
            print(
                "Некорректный формат данных трека."
            )
...
def download_with_ytdlp(
    ...
    # ЖЁСТКАЯ ЗАЩИТА
    #
    # Эта функция вообще не должна получать
    # ссылку Яндекс Музыки.
    # --------------------------------------------------------
    ...
    if not youtube_url:
        ...
        print()
        print(
            "Резервный yt-dlp пропущен:"
        )

        print(
            "YouTube URL отсутствует."
        )
    ...
    if is_yandex_music_url(
        ...
        print(
            "Попытка передать "
            "Яндекс-ссылку в yt-dlp "
            "заблокирована."
        )

        return False

    if not is_youtube_music_url(
        youtube_url
    ):
...
def find_and_download_track(
    ...
    # ВАЖНО
    #
    # Для Яндекс Музыки source_url НЕ используется
    # для скачивания.
    #
    # Он нужен только как информация об исходном
    # источнике метаданных.
    #
    # Аудио всегда ищется отдельно.
    # ========================================================
    ...
    if result:
        ...
        if download_file(
            ...
            print(
                "Источник аудио: MP3Party"
            )

            return filepath

        print(
            "MP3Party: скачать кандидат "
            "не удалось."
        )
    ...
    if result:
        ...
        if download_file(
            ...
            print(
                "Источник аудио: MP3TM"
            )

            return filepath

        print(
            "MP3TM: скачать кандидат "
            "не удалось."
        )
    ...
    if result:
        ...
        if download_file(
            ...
            print(
                "Источник аудио: AudioStart"
            )

            return filepath

        print(
            "AudioStart: скачать кандидат "
            "не удалось."
        )
        ...
        print(
            "AudioStart: подходящий кандидат "
            "не найден."
        )
    ...
    # Только YouTube.
    #
    # Для Яндекса этот блок НЕ ВЫПОЛНЯЕТСЯ.
    # ========================================================
...
def process_single_track(
    ...
    # ВАЖНО:
    #
    # Передаём source_url только для YouTube.
    #
    # Для Яндекса передаём None.
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Обложка применяется только после успешного
    # получения MP3.
    # --------------------------------------------------------
...
def main():
    ...
    # --------------------------------------------------------
    # Плейлисты сейчас остаются YouTube Music.
    # --------------------------------------------------------
