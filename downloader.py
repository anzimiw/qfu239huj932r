...
def embed_cover(mp3_filepath, cover_url, artist, title, album=""):
    """Скачивает обложку, конвертирует в JPEG и прикрепляет к MP3 в формате ID3v2.3"""
    ...
    try:
        ...
        if PIL_AVAILABLE:
            try:
                ...
                print("Предупреждение: Не удалось обработать изображение через Pillow:", img_err)
