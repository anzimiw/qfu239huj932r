...
# Отдельный User-Agent для LRCLIB.
# При публикации проекта ссылку можно заменить
# на фактический GitHub-репозиторий.
LRCLIB_USER_AGENT = (
    "YTMDownloader/1.0 "
    "(https://github.com/your-username/YTMDownloader)"
)
...
def find_and_download_track(
    ...
    # --------------------------------------------------------
    # Внутренний поиск.
    # Ничего из этого пользователю не показываем.
    # --------------------------------------------------------
