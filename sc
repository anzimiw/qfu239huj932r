...
def get_soundcloud_client_id():
    ...
    for pattern in patterns:
        ...
        if match:
            ...
            print(
                "client_id найден в HTML."
            )

            return client_id

    print(
        "client_id в HTML не найден."
    )
    ...
    print(
        "Не удалось найти client_id SoundCloud."
    )
...
def search_soundcloud(
    ...
    if not best_candidate:
        ...
        print()
        print(
            "Ни один SoundCloud-кандидат "
            "не совпадает по длительности."
        )
