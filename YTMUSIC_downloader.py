...
# Минимальный размер, ниже которого файл считаем пустым/битым.
MIN_FILE_SIZE = 10 * 1024

# Сколько раз пробуем скачать MP3Party.
MP3PARTY_RETRIES = 3
...
def get_playlist_tracks(url):
    ...
    try:
        ...
        for entry in entries:
            ...
            # Иногда flat-playlist может дать просто ID.
    ...
    try:
        ...
        for link in links:
            ...
            try:
                ...
                if (
                    wanted_artist in decoded_normalized
                    and
                    wanted_title in decoded_normalized
                ):
...
def find_and_download_track(
    ...
    if result:
        ...
        print()
        print(
            "MP3Party не смог отдать "
            "корректный аудиофайл."
        )
