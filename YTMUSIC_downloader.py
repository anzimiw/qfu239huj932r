...
def download_cover(
    ...
    try:
        ...
        if (
            ...
            print()
            print("Не удалось подготовить обложку.")
...
def embed_cover(
    ...
    try:
        ...
        # FFmpeg
        #
        # ID3v2.3 для максимальной совместимости
        # с Windows и музыкальными плеерами.
        # ----------------------------------------------------
        ...
        if (
            ...
            print()
            print("Не удалось встроить обложку.")
